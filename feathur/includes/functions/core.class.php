...
class Core
{
  ...
  public static function SendEmail($sTo, $sSubject, $sTemplate, $sVariable)
  {
    ...
    } elseif($sMail == 2)
    {
      ...
      {
        return $sReturn = array("content" => "Mandrill Error: {$e}");
      }
      return true;
    } else {
...
class VPSLogs extends CPHPDatabaseRecordClass
{
  ...
  public $prototype = array(
           'string' => array('Entry' => 'entry', 'Command' => 'command'),
           'numeric' => array('Timestamp' => 'timestamp', 'VPSId' => 'vps_id')
         );
}
...
class ServerLogs extends CPHPDatabaseRecordClass
{
  ...
  public $prototype = array(
           'string'  => array('Entry' => 'entry', 'Command' => 'command'),
           'numeric' => array('Timestamp' => 'timestamp', 'ServerId' => 'server_id')
         );
...
class ServerCommands extends CPHPDatabaseRecordClass
{
  ...
  public $prototype = array(
           'string'  => array('Command' => 'command'),
           'numeric' => array('Last' => 'last', 'Interval' => 'interval', 'ServerId' => 'server_id')
         );
}
